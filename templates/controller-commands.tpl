				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form role="form" action="{{.URLPathPrefix}}/admin/controller-commands/exec/" method="post">
							<div class="row">
								<div class="col-lg-6">					
									<div class="form-group">
										<label>Master Bot Controller</label>
										<select class="form-control" name="PermURL" id="PermURL" size="1">
											<option value="0" selected="selected" disabled="disabled">Please choose a master bot controller</option>
											{{.MasterBotControllers}}
										</select>
									</div> <!-- /.form-group -->
								</div> <!-- /.col-lg.6 -->
								<div class="col-lg-6">					
									<div class="form-group">
										...
										<select class="form-control" name="NPC" id="NPC" size="1">
											<option value="0" selected="selected" disabled="disabled">Please choose an agent name</option>
											{{.AgentNames}}
										</select>
									</div> <!-- /.form-group -->
								</div> <!-- /.col-lg.6 -->
