...
function onRemoveSelected() {
	var selectedNodes = gridOptions.api.getSelectedNodes(), ids = "";
	
	selectedNodes.api.forEachNode( function(node) {
		ids += node.UUID + ",";
		}
	);
	// remove last comma
	ids = ids.replace(/,\s*$/, ""); // see https://stackoverflow.com/questions/17720264/remove-last-comma-from-a-string
